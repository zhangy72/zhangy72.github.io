	...
	<div id="content">
		<div class="post">
			 ...
			 <div class="middle_back">     
				...
				<p class="STYLE5">nick.zhangyuan@gmail.com</p>
				<p class="STYLE5">&nbsp;</p>
				<p class="STYLE5">Wenbo Qiao: </p>
				<p class="STYLE5">qiaowb@gmai.com</p>
				<p class="STYLE5">&nbsp;</p>
				<p class="STYLE5">Rujira Achawanantakun: </p>
				<p class="STYLE5">rujiraa@gmail.com</p>
				<p>&nbsp;</p>
				<p>&nbsp;</p>
			 </div>
	         </div>
		     <div class="line1">
					 <h2 class="title">Thank Your for Your Message!</h2>
				     <div class="middle_back">
				       <span class="STYLE8">Thank you so much for your message. We will reply to your message via email soon! Have a nice day!				       </span><br />
		   </div>
		     </div>
      </div>
	</div>
